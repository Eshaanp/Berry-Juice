...
public class TestLobbyScript : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        //funtionality
        //call heartbeat to keep lobby alive
        HandleLobbyHeartbeat();
        HandleLobbyPollForUpdates();
    }

    //15 sec heartbeat timer
    ...
    private async void ListLobbies()
    {
        try
        {
            //filter lobbies- add more later (code monkey lobby 15:30)
    ...
    //testing lobby code cant be done until ui made 
    ...
    //will fail if only private lobbies
